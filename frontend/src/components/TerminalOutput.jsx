...
export default function TerminalOutput({ lines }) {
  ...
  return (
    <div className="terminal-output max-w-full overflow-x-auto rounded-xl border border-neon/30 bg-black/70 p-3 font-mono text-xs md:text-sm text-neon shadow-neon">
